...
PLUGIN_HUB="${WEBROOT}/nofida/ai-core/nofida-plugin-hub.js"
EDITOR_SIDEBAR_JS="${WEBROOT}/nofida/ai-core/nofida-editor-sidebar.js"
...
for templated_file in "${BRAND_CSS}" "${PAGES_CSS}" "${NAVIGATION_JS}" "${AI_CORE}" "${PAGES_JS}" "${RESOURCES_JS}" "${LIB_HUB}" "${PLUGIN_HUB}" "${EDITOR_SIDEBAR_JS}" "${MANIFEST_FILE}"; do
...
grep -q 'nofida-resources.js' "${INDEX}" || \
  sed -i "/<\/body>/i\\    <script src=\"/nofida/ai-core/nofida-resources.js?v=${ASSET_TAG}\" defer></script>" "${INDEX}"
...
grep -q 'nofida-plugin-hub.js' "${INDEX}" || \
  sed -i "/<\/body>/i\\    <script src=\"/nofida/ai-core/nofida-plugin-hub.js?v=${ASSET_TAG}\" defer></script>" "${INDEX}"
grep -q 'nofida-editor-sidebar.js' "${INDEX}" || \
  sed -i "/<\/body>/i\\    <script src=\"/nofida/ai-core/nofida-editor-sidebar.js?v=${ASSET_TAG}\" defer></script>" "${INDEX}"
