...
(function () {
  ...
  function renderModelLibraryTab() {
    ...
    return [
      ...
      '  <div class="field grow"><label>Find a model…</label><input id="settings-search" class="text-input" type="search" value="' + escapeHtml(state.settingsUi.search || "") + '" placeholder="Find a model…" /></div>',
  ...
  function renderEngineTab() {
    ...
    return [
      ...
      "  </div>",
      '  <button class="btn ghost" type="button" data-action="refresh-settings">Refresh</button>',
      "</div>",
  ...
  function getAccountSettingsScopedStyles() {
    return [
      '#nofida-ai-account-page-host{display:block;width:100%;margin:0 0 24px}',
      '#nofida-ai-account-page-host *{box-sizing:border-box;font-family:' + BRAND.font + '}',
      '#nofida-ai-account-page-host .account-shell{display:flex;flex-direction:column;gap:16px;border:1px solid ' + BRAND.border + ';border-radius:28px;background:linear-gradient(180deg,rgba(13,19,36,.98),rgba(8,12,24,.98));box-shadow:0 24px 64px rgba(2,6,23,.35);padding:20px 22px;color:' + BRAND.text + '}',
      '#nofida-ai-account-page-host .account-shell.page{padding:22px 24px 24px}',
      '#nofida-ai-account-page-host .account-shell.launcher{background:linear-gradient(135deg,rgba(15,23,42,.98),rgba(19,30,53,.98))}',
      '#nofida-ai-account-page-host .account-head{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap}',
      '#nofida-ai-account-page-host .account-head h2{margin:6px 0 0;font-size:28px;line-height:1.05;font-weight:900}',
      '#nofida-ai-account-page-host .account-head p{margin:8px 0 0;color:' + BRAND.muted + ';font-size:13px;line-height:1.6;max-width:860px}',
      '#nofida-ai-account-page-host .eyebrow{display:inline-flex;align-items:center;gap:8px;padding:7px 11px;border-radius:999px;background:' + BRAND.accentSoft + ';color:#d1fae5;font-size:11px;font-weight:900;letter-spacing:.08em;text-transform:uppercase}',
      '#nofida-ai-account-page-host .eyebrow::before{content:"";width:8px;height:8px;border-radius:999px;background:' + BRAND.accent + '}',
      '#nofida-ai-account-page-host .metrics{display:flex;gap:12px;flex-wrap:wrap}',
      '#nofida-ai-account-page-host .metric{min-width:160px;padding:12px 14px;border-radius:16px;background:rgba(7,12,24,.78);border:1px solid ' + BRAND.border + '}',
      '#nofida-ai-account-page-host .metric strong{display:block;font-size:22px;line-height:1;font-weight:900;margin-bottom:6px}',
      '#nofida-ai-account-page-host .metric span{font-size:12px;color:' + BRAND.muted + '}',
      '#nofida-ai-account-page-host .launcher-actions{display:flex;gap:12px;flex-wrap:wrap}',
      '#nofida-ai-account-page-host .btn{border:0;border-radius:12px;padding:10px 14px;font-size:12px;font-weight:800;cursor:pointer}',
      ...
      '#nofida-ai-account-page-host .btn.tiny{padding:8px 10px;font-size:11px}',
      '#nofida-ai-account-page-host .btn:disabled{opacity:.45;cursor:default}',
      '#nofida-ai-account-page-host .settings-tabs{display:flex;gap:8px;flex-wrap:wrap;padding:0}',
      '#nofida-ai-account-page-host .settings-tab{border:1px solid ' + BRAND.border + ';border-radius:999px;background:rgba(15,23,42,.72);color:' + BRAND.muted + ';padding:9px 14px;font-size:12px;font-weight:800;cursor:pointer;white-space:nowrap}',
      '#nofida-ai-account-page-host .settings-tab.active{background:' + BRAND.primary + ';border-color:' + BRAND.primary + ';color:#fff}',
      '#nofida-ai-account-page-host .settings-body{display:flex;flex-direction:column;gap:18px}',
      '#nofida-ai-account-page-host .settings-section-head{display:flex;align-items:flex-end;justify-content:space-between;gap:14px}',
      '#nofida-ai-account-page-host .settings-section-head.slim{margin-top:8px}',
      '#nofida-ai-account-page-host .settings-section-head h3{margin:0 0 6px;font-size:18px}',
      ...
      '#nofida-ai-account-page-host .text-input,#nofida-ai-account-page-host .select-input{width:100%;border:1px solid ' + BRAND.border + ';border-radius:14px;background:rgba(7,12,24,.92);color:' + BRAND.text + ';padding:11px 12px;font-size:13px;outline:none}',
      '#nofida-ai-account-page-host .saved-key{padding:11px 12px;border-radius:14px;background:rgba(7,12,24,.92);border:1px solid ' + BRAND.border + ';color:' + BRAND.text + ';font-family:ui-monospace,SFMono-Regular,Consolas,monospace;font-size:13px}',
      '#nofida-ai-account-page-host .provider-grid,#nofida-ai-account-page-host .model-grid,#nofida-ai-account-page-host .assignment-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(290px,1fr));gap:14px}',
      '#nofida-ai-account-page-host .provider-card,#nofida-ai-account-page-host .model-card,#nofida-ai-account-page-host .assignment-card,#nofida-ai-account-page-host .placeholder-block{border:1px solid ' + BRAND.border + ';border-radius:20px;background:' + BRAND.surfaceSoft + ';padding:16px;display:flex;flex-direction:column;gap:12px}',
      '#nofida-ai-account-page-host .provider-top,#nofida-ai-account-page-host .model-head,#nofida-ai-account-page-host .assignment-top{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}',
      '#nofida-ai-account-page-host .provider-top h3,#nofida-ai-account-page-host .model-copy h3,#nofida-ai-account-page-host .assignment-top h4,#nofida-ai-account-page-host .placeholder-block h3{margin:0;font-size:17px}',
      ...
      '#nofida-ai-account-page-host .model-desc{min-height:54px}',
      '#nofida-ai-account-page-host .provider-actions{display:flex;gap:10px;flex-wrap:wrap}',
      ...
      '#nofida-ai-account-page-host .empty-state,#nofida-ai-account-page-host .loading-panel{padding:18px;border:1px dashed ' + BRAND.border + ';border-radius:16px;color:' + BRAND.muted + ';font-size:13px;line-height:1.5;background:rgba(11,16,32,.82)}',
      '#nofida-ai-account-page-host .empty-state.slim{padding:12px}',
      '#nofida-ai-account-page-host .error-text{color:#fecaca}',
      '#nofida-ai-account-page-host .launcher-note{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px}',
      '#nofida-ai-account-page-host .launcher-copy{padding:12px 14px;border-radius:16px;background:rgba(7,12,24,.78);border:1px solid ' + BRAND.border + ';color:' + BRAND.muted + ';font-size:13px;line-height:1.5}',
      ...
      '@media (max-width:820px){#nofida-ai-account-page-host .account-head h2{font-size:24px}#nofida-ai-account-page-host .settings-toolbar,#nofida-ai-account-page-host .field-row,#nofida-ai-account-page-host .field-row.compact{grid-template-columns:1fr}}'
    ].join("");
  }
  ...
  function renderAccountSettingsHost() {
    ...
    host.innerHTML = [
      ...
      activePage ? [
        ...
        "    </div>",
        '    <div class="provider-actions">',
        '      <button class="btn ghost" type="button" data-action="close-account-ai-settings">Back to General Settings</button>',
        '      <button class="btn primary" type="button" data-action="refresh-settings">Refresh</button>',
        "    </div>",
        "  </div>",
        ...
        '      <h2>Provider Settings in Your Account</h2>',
        '      <p>This is the dedicated account page for provider keys, model assignments, engine routing, and safe model testing. Open it directly from here instead of the floating assistant panel.</p>',
        "    </div>",
        '    <div class="launcher-actions">',
        '      <button class="btn primary" type="button" data-action="open-account-ai-settings" data-settings-tab="api">Open AI Settings Page</button>',
        '      <button class="btn ghost" type="button" data-action="open-account-ai-settings" data-settings-tab="models">Go to Model Library</button>',
        "    </div>",
        "  </div>",
        '  <div class="metrics">',
        '    <div class="metric"><strong>' + escapeHtml(String(summary.configuredProviders)) + '</strong><span>configured providers</span></div>',
        '    <div class="metric"><strong>' + escapeHtml(String(summary.totalModels || 0)) + '</strong><span>models in library</span></div>',
        '    <div class="metric"><strong>' + escapeHtml(String(summary.assignedRoles)) + '</strong><span>assigned roles</span></div>',
        "  </div>",
        '  <div class="launcher-note">',
        '    <div class="launcher-copy">API keys remain server-side only and are always shown masked in the UI.</div>',
        '    <div class="launcher-copy">Role assignments persist across reloads and are used by <code>/api/nofida/ai/ask</code>.</div>',
        '    <div class="launcher-copy">Open the full page to test providers and assign models by role.</div>',
        "  </div>",
        "</section>"
      ].join("")
    ].join("");
